...
class XOptions:
    ...
    def add_public_options(self):
        ...
        pub_group.add_option("--copy-all", action="store_true", help="copy vlg/vhd/nog file if found it in ldf_dir")
    ...
    def add_project_options(self):
        ...
        frontend_group.add_option("--synthesis-only", action="store_true", help="run synthesis only")
