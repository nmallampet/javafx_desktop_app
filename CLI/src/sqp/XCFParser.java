...
//                mainTitle = nNode.getAttributes().getNamedItem("title").getNodeValue();
//            }
//            
...
//            }
//            
//            if(mainTitle != null && implTitle != null) {
//                String bitFileName = mainTitle + "_" + implTitle + ".bit";
//                return bitFileName;
//            }
//            else {
//                System.err.println(String.format("Couldn't parse ldf file: %s, retrived: %s_%s.bit", file.getName(), mainTitle, implTitle));
//                return null;
//            }
//            
//        }
...
//            Node PaddNodeVendor = doc.getElementsByTagName("Vendor").item(index);
//            PaddNodeVendor.setTextContent(vendor);
//            
//            Node PaddNodeFamily = doc.getElementsByTagName("Family").item(index);
//            PaddNodeFamily.setTextContent(family);
//            
//            Node PadNodeName = doc.getElementsByTagName("Name").item(index);
//            PadNodeName.setTextContent(dev);
//            
//            Node PadNodeID = doc.getElementsByTagName("IDCode").item(index);
//            PadNodeID.setTextContent(id);
//            
//            Node PadNodePon = doc.getElementsByTagName("PON").item(index);
//            PadNodePon.setTextContent(dev);
