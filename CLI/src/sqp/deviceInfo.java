...
//        String patternFamily = "-a \"(.+)\"";
//        Pattern pF = Pattern.compile(patternFamily);
//        String patternDev = "-d (.+)";
//        Pattern pD = Pattern.compile(patternDev);
//        
//        boolean foundF = false;
//        boolean foundD = false;
//        
//        try {
//            Scanner s = new Scanner(this.ldfFile);
//            while (s.hasNextLine()) {
//                String line = s.nextLine();
//                Matcher mF = pF.matcher(line);
//                if(mF.find()) {
//                    setFamily(mF.group(1));
//                    foundF = true;
//                }
//                Matcher mD = pD.matcher(line);
//                if(mD.find()) {
//                    setDevName(mD.group(1));
//                    foundD = true;
//                }
//                
//                if(foundF && foundD)
...
//        catch(Exception e) {
//            e.printStackTrace();
//            System.err.println("Error parsing synprojfile folder");
//        }
//    }
