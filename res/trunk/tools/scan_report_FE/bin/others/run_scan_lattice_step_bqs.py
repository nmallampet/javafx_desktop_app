...
from xlib import report_sort_bqs
def option():
    ...
    public_group.add_option("--report-dir", help="specify directory where the report will place")
...
def scan_report():
    ...
    if 1:
        ...
        if 1:
            ...
            report_file = os.path.join(opt.job_dir,dir+'_'+design+'.csv')
